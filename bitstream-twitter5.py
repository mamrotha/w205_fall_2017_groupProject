...
#        print("================================================")
        ...
        if 'text' in json_data:
            ...
            conn = psycopg2.connect(database="crypto", user="postgres", password="foobar", host="localhost", port="5432")
            cur = conn.cursor()
            cur.execute("INSERT INTO tweets (tweet,created_at,lang,coordinates,user_time_zone) VALUES (%s,%s,%s,%s,%s)",(tweet, created_at,lang,coordinates,user_time_zone));
...
my_stream_listener = MyStreamListener(10)
